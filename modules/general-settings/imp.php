...
final class Birchschedule_Gsettings_Imp {
    ...
    static function wp_init() {
        ...
        add_filter('birchschedule_model_get_first_day_of_week', 
            array(__CLASS__, 'get_first_day_of_week'));
    ...
    static function add_settings_fields() {
        ...
        add_settings_field('birchschedule_date_time_format', __('Date Format, Time Format'), 
            array(__CLASS__, 'render_date_time_format'), 'birchschedule_settings', 'birchschedule_general');
        add_settings_field('birchschedule_start_of_week', __('Week Starts On'), 
            array(__CLASS__, 'render_start_of_week'), 'birchschedule_settings', 'birchschedule_general');
        add_settings_field('birchschedule_currency', __('Currency'), 
            array(__CLASS__, 'render_currency'), 'birchschedule_settings', 'birchschedule_general');
        add_settings_field('birchschedule_default_calendar_view', __('Default Calendar View'), 
