...
(function($, undefined) {
    ...
    function getServerNow(options){
        var now = new Date();
        var localOffset = now.getTimezoneOffset();
        var serverOffset = options.gmtOffset;
        var timestamp = now.getTime() + (localOffset - serverOffset) * 60 * 1000;
	...
	-----------------------------------------------------------------------------*/
        ...
        function renderView(inc) {
            if (elementVisible()) {
                ...
                var today = getServerNow(options);
...
*/
	...
	------------------------------------------------------------*/
        ...
        function updateCells(firstTime) {
            ...
            var today = clearTime(getServerNow(calendar.options));
            var cell;
            var date;
            var row;
