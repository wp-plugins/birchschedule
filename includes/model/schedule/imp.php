...
final class Birchschedule_Model_Schedule_Imp {
    ...
    private static function get_exceptions_blocks( $exceptions ) {
        ...
        foreach ( $min_blocks as $min_block ) {
            if ( !in_array( $min_block, $exceptions_blocks ) &&
                !in_array( $min_block + self::$step_length, $exceptions_blocks ) ) {
    ...
    static function get_fully_booked_days() {
    ...
    static function clean_past_fully_booked( $fully_booked ) {
        global $birchschedule, $birchpress;
    ...
    static function mark_fully_booked_day( $staff_id, $location_id, $service_id, $date_text ) {
        global $birchschedule;
    ...
    static function unmark_fully_booked_day( $staff_id, $location_id, $service_id, $date_text ) {
        global $birchschedule;
