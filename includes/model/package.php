...
birch_ns( 'birchschedule.model', function( $ns ) {
		...
		birch_defn( $ns, 'get_service_padding_before', function( $service_id ) use ( $ns ) {
				return $ns->get_service_padding( $service_id, 'before' );
			} );

		birch_defn( $ns, 'get_service_padding_after', function( $service_id ) use ( $ns ) {
		...
		birch_defn( $ns, 'get_service_length_with_paddings', function( $service_id ) use ( $ns ) {
		...
		birch_defn( $ns, 'get_service_timeslot', function( $service_id ) {
				return 15;
			} );

		birch_defn( $ns, 'get_service_capacity', function( $service_id ) {
				return 1;
			} );
		...
		birch_defn( $ns, 'get_default_country', function() {
				return 'US';
			} );

		birch_defn( $ns, 'get_default_state', function() {
				return false;
			} );
		...
		birch_defn( $ns, 'check_password', function( $email, $password ) {
		...
		birch_defn( $ns, 'get_appointment_fields', function() {
				$meta_keys = array(
		...
		birch_defn( $ns, 'get_appointment1on1_fields', function() {
				return
				array(
		...
		birch_defn( $ns, 'get_appointment1on1_custom_fields', function() {
		...
		birch_defn( $ns, 'get_client_fields', function() {
		...
		birch_defn( $ns, 'get_payment_fields', function() {
				return array(
		...
		birch_defn( $ns, 'get_meta_key_label', function( $meta_key ) {
				return '';
			} );
		...
		birch_defn( $ns, 'get_services_by_staff', function( $staff_id ) {
		...
		birch_defn( $ns, 'get_staff_by_service', function( $service_id ) {
		...
		birch_defn( $ns, 'get_staff_listing_order_type', function() {
				return 'by_title';
			} );
		...
		birch_defn( $ns, 'apply_currency_symbol', function( $val, $curreny_code ) {
				global $birchpress;
		...
		birch_defn( $ns, 'get_currency_code', function() {
				return 'USD';
			} );

		birch_defn( $ns, 'get_cut_off_time', function( $staff_id = -1, $location_id = -1, $service_id = -1 ) {
				return 1;
			} );

		birch_defn( $ns, 'get_future_time', function() {
				return 360;
			} );

		birch_defn( $ns, 'get_time_before_cancel', function() {
				return 24;
			} );

		birch_defn( $ns, 'get_time_before_reschedule', function() {
				return 24;
			} );
