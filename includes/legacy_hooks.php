...
add_filter('birchschedule_model_get_staff_busy_time', 'birchschedule_staff_busy_time', 100, 4);
...
add_filter('birchschedule_model_get_staff_avaliable_time', 
...
add_filter('birchschedule_model_get_appointment_merge_values', 
