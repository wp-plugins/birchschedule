...
if (!class_exists('Birchpress_Lang_Package')) {
	...
	abstract class Birchpress_Lang_Package {
		...
		public function add_action($tag, $func, $priority = 10, $accepted_args = 1) {
			birch_assert(is_string($func));
			add_action($tag, array($this, $func), $priority, $accepted_args);
		}
	    ...
	    public function define_multimethod($multi, $subject = "subject") {
	    	global $birchpress;
			$birchpress->lang->define_multimethod($this, $multi, $subject);        	
	    }
