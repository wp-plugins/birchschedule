	...
	class Birchpress_Lang {
        ...
        public function dispatch($package, $method_name, $arguments) {
            ...
            birch_assert(isset($this->dispatch_map[$func_name]), 
                ...
                $package->get_name() . ' is not defined.');
            ...
            do_action_ref_array($hook_name . '_before', $arguments);
            ...
            do_action_ref_array($hook_name . '_after', array_merge($arguments, array($result)));
            return $result;
        }
