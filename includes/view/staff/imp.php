...
final class Birchschedule_View_Staff_Imp {
    ...
    static function get_default_new_schedule() {
        return array(
            'minutes_start' => 540,
            'minutes_end' => 1020,
            'weeks' => array(
    ...
    static function ajax_new_schedule() {
        ...
        $uid = uniqid();
        $schedule = $birchschedule->view->staff->get_default_new_schedule();
        $birchschedule->view->staff->render_schedule_block( $location_id, $uid, $schedule );
        die;
    }
...
?>
    ...
    static function render_schedule_block( $location_id, $uid, $schedule ) {
        global $birchschedule;
