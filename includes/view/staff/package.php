...
birch_ns( 'birchschedule.view.staff', function( $ns ) {
        ...
        birch_defn( $ns, 'get_default_new_schedule', function() {
                return array(
                    'minutes_start' => 540,
                    'minutes_end' => 1020,
                    'weeks' => array(
        ...
        birch_defn( $ns, 'ajax_new_schedule', function() use ( $ns ) {
        ...
        birch_defn( $ns, 'get_schedule_interval', function() {
                return 5;
            } );

        birch_defn( $ns, 'render_schedule', function( $location_id, $uid, $schedule ) use ( $ns ) {
...
<?php
        ...
        birch_defn( $ns, 'render_schedule_block', function( $location_id, $uid, $schedule ) use ( $ns ) {
...
<?php
        ...
        birch_defn( $ns, 'render_timetable', function( $staff_id, $location_id ) use ( $ns ) {
                global $birchschedule;
...
<?php
        ...
        birch_defn( $ns, 'render_work_schedule', function( $post ) use ( $ns ) {
...
<?php
        ...
        birch_defn( $ns, 'render_service_checkboxes', function( $services, $assigned_services ) {
        ...
        birch_defn( $ns, 'render_assign_services', function( $post ) use ( $ns ) {
                $services = get_posts(
                    array(
