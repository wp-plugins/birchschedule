...
class Birchschedule_View_Bookingadmin_Imp {
    ...
    static function get_scripts() {
        ...
        $scripts[] = array('birs_admin_appointment_edit', 
            'birs_appointment_edit_params', $appointment_edit_params);
    ...
    static function save_appointment() {
        ...
        $appointment = $birchschedule->view->bookingadmin->extract_appointment();
