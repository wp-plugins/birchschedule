...
class Birchschedule_View_Clients_Imp {
    ...
    static function wp_admin_init() {
        ...
        $package = $birchschedule->view->clients;
        $package->add_filter('manage_edit-birs_client_columns', 'get_edit_columns');
        $package->add_action('manage_birs_client_posts_custom_column', 'render_custom_columns', 2);
    }
    ...
    static function enqueue_scripts_edit_birs_client($arg) {
        ...
        $birchschedule->view->enqueue_scripts(array('birs_admin_client'));
    ...
    static function validate_data($client_id) {
        ...
        if(!is_email($_POST['birs_client_email'])) {
        	...
        	if(self::email_exists($client_id)) {
    ...
    static function email_exists($client_id) {
        global $birchschedule;
                ...
                <tr class="form-field">
                    ...
                    <td>
                        <select name="birs_client_country" id="birs_client_country">
                            <?php $birchpress->util->render_html_options($countries, $country, $default_country); ?>
                        </select>
