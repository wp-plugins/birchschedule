...
class Birchschedule_View_Staff_Imp {
	...
	static function wp_admin_init() {
        ...
        $package->add_action('wp_ajax_birchschedule_view_staff_new_schedule', 'ajax_new_schedule');
        $package->add_filter('manage_edit-birs_staff_columns', 'get_edit_columns');
        $package->add_action('manage_birs_staff_posts_custom_column', 'render_custom_columns', 2);
    }
    ...
    static function enqueue_scripts_edit_birs_staff($arg) {
        ...
        $birchschedule->view->enqueue_scripts('birchschedule_view_staffediting');
        $birchschedule->view->enqueue_styles(
            array(
                'birchschedule_admincommon', 'birchschedule_staffediting',
