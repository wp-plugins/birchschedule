...
class Birchschedule_View_Services_Imp {
	...
	static function wp_admin_init() {
        ...
        $package->add_filter('manage_edit-birs_service_columns', 'get_edit_columns');
        $package->add_action('manage_birs_service_posts_custom_column', 'render_custom_columns', 2);
	}
    ...
    static function enqueue_scripts_edit_birs_service($arg) {
        ...
        $birchschedule->view->enqueue_scripts(array('birchschedule_view_serviceediting'));
        $birchschedule->view->enqueue_styles(array('birchschedule_admincommon', 
            'birchschedule_serviceediting'));
    }
    ...
    static function add_meta_boxes() {
        ...
        add_meta_box('birchschedule-service-staff', __('Staff', 'birchschedule'), 
    ...
    static function render_assign_staff($post) {
        ...
        <div class="panel-wrap birchschedule">
            ...
            <?php else: ?>
                <p>
                    <?php
                    printf(__('There is no staff to assign. Click %s here %s to add one.', 'birchschedule'), '<a
