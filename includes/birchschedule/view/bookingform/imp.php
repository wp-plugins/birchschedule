...
final class Birchschedule_View_Bookingform_Imp {
    ...
    static function schedule() {
        ...
        $appointment1on1_id = self::$birchschedule->model->booking->schedule_appointment1on1($appointment1on1_info);
    ...
    static function get_fields_html() {
        ...
        <li class="birs_form_field birs_appointment_staff"> 
            ...
            <div class="birs_field_content">
                ...
                <input id="birs_appointment_avaliable_staff" name="birs_appointment_avaliable_staff" />
            </div>
