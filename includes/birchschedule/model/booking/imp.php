...
final class Birchschedule_Model_Booking_Imp {
    ...
    static function _return_same_appointments($appointments) {
        return $appointments;
    }
    ...
    static function delete_appointment($appointment_id) {
        $appointment1on1s = 
            self::$package->get_appointment1on1s_by_appointment($appointment_id, array(), 'any');
        foreach($appointment1on1s as $appointment1on1_id => $appointment1on1) {
    ...
    static function delete_appointments($start, $end, $location_id, $staff_id) {
        $appointments = 
            self::$package->query_appointments(
                $start, $end, $location_id, $staff_id, 
                array(), array(self::$package, '_return_same_appointments')
            );
