...
if(!class_exists('Birchschedule_Model')) {
	...
	class Birchschedule_Model extends Birchpress_Lang_Package {
		...
		public function define_interface() {	
			...
			$this->define_function('get_default_state');

			$this->define_function('update_model_relations');

			$this->define_function('is_prepayment_enabled');

			$this->define_function('cancel_appointment');

			//facade
			$this->define_function('check_password', 
				array('Birchschedule_Model_Facade_Imp', 'check_password'));
			...
			$this->define_function('get_time_before_cancel', 
				array('Birchschedule_Model_Facade_Imp', 'get_time_before_cancel'));
			
			$this->define_function('get_time_before_reschedule', 
				array('Birchschedule_Model_Facade_Imp', 'get_time_before_reschedule'));

			$this->define_function('if_cancel_appointment_outoftime', 
				array('Birchschedule_Model_Facade_Imp', 'if_cancel_appointment_outoftime'));

			$this->define_function('if_reschedule_appointment_outoftime', 
				array('Birchschedule_Model_Facade_Imp', 'if_reschedule_appointment_outoftime'));
			...
			//merge fields
			$this->define_function('get_appointment_merge_values', 
				array('Birchschedule_Model_Mergefields_Imp', 'get_appointment_merge_values'));
