...
birch_ns( 'birchpress.util', function( $ns ) {
        ...
        birch_defn( $ns, 'new_errors', function ( $code = '', $message = '', $data = '' ) use ( $ns ) {
                return new WP_Error( $code, $message, $data );
            } );

        birch_defn( $ns, 'add_error', function ( $errors, $code, $message, $data = '' ) use( $ns ) {
                ...
                foreach ( $args as $arg ) {
                    if ( $ns->is_errors( $arg ) ) {
                        ...
                        foreach ( $codes as $code ) {
                            ...
                            $ns->add_error( $errors, $code, $message );
                        }
                    }
