...
if (!class_exists('Birchschedule')) :
    ...
    class Birchschedule {
        ...
        function register_common_styles() {
            $version = $this->version;
            wp_register_style('birs_lib_fullcalendar', $this->plugin_url() . '/assets/js/fullcalendar/fullcalendar.css', array(), '1.5.3');
            wp_register_style('jquery-ui-bootstrap', $this->plugin_url() . '/assets/css/jquery-ui-bootstrap/jquery-ui-1.8.16.custom.css', array(), '0.23');
        ...
        private function create_menu_birchschedule($position) {
            ...
            add_menu_page(__('Scheduler', 'birchschedule'), __('Scheduler', 'birchschedule'), 'publish_posts', 'birchschedule_schedule', '', $icon_url, $position);
            $this->calendar_view->page_hook = add_submenu_page('birchschedule_schedule', __('Calendar', 'birchschedule'), __('Calendar', 'birchschedule'), 'publish_posts', 'birchschedule_calendar', array(&$this->calendar_view, 'render_admin_page'));
            $this->settings_view->page_hook = add_submenu_page('birchschedule_schedule', __('BirchPress Scheduler Settings', 'birchschedule'), __('Settings', 'birchschedule'), 'manage_options', 'birchschedule_settings', array(&$this->settings_view, 'render_admin_page'));
