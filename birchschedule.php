...
if (!class_exists('Birchschedule')) :
    ...
    class Birchschedule {
        ...
        public function __construct() {
            $this->version = '1.1.0';
            $this->product_version = '1.1.0';
            $this->product_name = 'BirchSchedule';
        ...
        public function create_admin_menu() {
            ...
            $this->create_menu_birchschedule($position++);
        ...
        private function create_menu_birchschedule($position) {
            ...
            $this->settings_view->page_hook = add_submenu_page('birchschedule_schedule', __('BirchSchedule Settings', 'birchschedule'), __('Settings', 'birchschedule'), 'manage_options', 'birchschedule_settings', array(&$this->settings_view, 'render_admin_page'));
