...
class BIRS_Calendar_View extends BIRS_Admin_View {
    ...
    function get_admin_scripts() {
        return array('birs_admin_calendar', 'birs_admin_appointment_edit');
    }
    ...
    function add_admin_scripts($hook) {
        ...
        wp_localize_script('birs_admin_calendar', 'birs_calendar_params', $params);
        ...
        wp_localize_script('birs_admin_appointment_edit', 'birs_appointment_edit_params', $appointment_edit_params);
        do_action('birchschedule_add_admin_scripts_calendar_view');
    }
    ...
    function render_location_options() {
        ...
        $this->get_util()->render_html_options($locations);
