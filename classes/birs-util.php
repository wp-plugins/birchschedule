...
class BIRS_Util {
    ...
    public function convert_to_datetime($timestamp) {
        ...
        return $this->date_i18n($date_format, $timestamp) . ' ' . $datetime->format($time_format);
    }
    ...
    function get_currencies() {
        return array(
            ...
            'AUS' => array('title' => __('Australian Dollar', 'birchschedule'), 'code' => 'AUS', 'symbol_left' => '$', 'symbol_right' => '', 'decimal_point' => '.', 'thousands_point' => ',', 'decimal_places' => '2'),
