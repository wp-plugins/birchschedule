...
class BIRS_Shortcode {
    ...
    function init() {
        add_shortcode(self::SHORTCODE_NAME, array(&$this, 'get_shortcode_uid'));
    ...
    function get_shortcode_html($attr) {
        ...
        <style type="text/css">
        <?php
            echo apply_filters('birchschedule_custom_code_css', '');
        ?>
        </style>
        <div class="birchschedule" id="birs_booking_box">
            <form id="birs_appointment_form">
                ...
                <input type="hidden" id="birs_shortcode_page_url" name="birs_shortcode_page_url" 
    ...
    function get_form_fields_html($html) {
        ...
        <li class="birs_form_field <?php echo $hide_location_class; ?>">
