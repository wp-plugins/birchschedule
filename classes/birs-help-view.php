...
class BIRS_Help_View extends BIRS_Admin_View {
    ...
    function render_help_general() {
        ?>
        <div class="padding">
            <p>If you have any questions, please review the <a href="http://www.birchpress.com/support/quick-start-guide">tutorial</a>. If you cannot find the answer you need, please start a <a href="http://www.birchpress.com/support/forums">support topic</a> and we will answer your question as soon as possible.</p>
            <p>If you find our product helpful, please <a href="http://wordpress.org/extend/plugins/birchschedule">rate it!</a></p>
            <p>If you find a bug in this plugin or have a suggestion, please submit it through our <a href="http://www.birchpress.com/support/forums">support forums</a> with a clear description.</p>
        </div>
        <?php
    }
