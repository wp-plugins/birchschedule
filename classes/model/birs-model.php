...
class BIRS_Model implements ArrayAccess, IteratorAggregate {
    ...
    var $trigger_hooks = array(
        'inserted', 'updated', 'pre_delete', 
    ...
    public function __construct($id, $options=array()) {
        ...
        if(isset($options['trigger_hooks'])) {
            $this->trigger_hooks = $options['trigger_hooks'];
        }
    }
    ...
    public function pre_delete() {
        if(in_array('pre_delete', $this->trigger_hooks)) {
    ...
    public function delete() {
        ...
        if(wp_delete_post($this->ID)) {
            if(in_array('deleted', $this->trigger_hooks)) {
