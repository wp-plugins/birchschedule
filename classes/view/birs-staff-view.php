...
class BIRS_Staff_View extends BIRS_Content_View {
    ...
    function get_admin_styles() {
        return array('birchschedule_admin_styles', 'birchschedule_admin_staff');
    }
    ...
    function render_schedule($location_id, $uid, $schedule) {
        $interval = apply_filters('birchschedule_staff_schedule_interval', 5);
        $time_options = $this->get_util()->get_time_options($interval);
