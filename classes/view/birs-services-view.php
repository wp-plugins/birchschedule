...
class BIRS_Services_View extends BIRS_Content_View {
    ...
    function get_admin_styles() {
        return array('birchschedule_admin_styles', 'birchschedule_admin_services');
    }
    ...
    function get_admin_scripts() {
        return array('birs_admin_service');
    }
    ...
    function render_service_info($post) {
        ...
        <div class="panel-wrap birchschedule">
            <table class="form-table">
                ...
                <?php do_action('birchschedule_service_basic_settings_after', $post_id); ?>
            </table>
        </div>
        <?php
    }
